...
import YouTubeFacade from "@/components/trial/YouTubeFacade";
...
const CSS = `
  ...
  /* ── Hero ── */
  .tp-hero { position: relative; padding: 24px 0 56px; overflow: hidden; isolation: isolate; background: var(--tp-bg); }
  ...
  .tp-cases-note {
    margin-top: 20px; text-align: center; color: var(--tp-text-muted);
