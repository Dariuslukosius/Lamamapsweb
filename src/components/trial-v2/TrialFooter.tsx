...
const TrialFooter = () => (
  <footer id="contacts" className="t2-footer">
    <div className="t2-footer-inner">
      <a href="#t2-home" className="t2-footer-logo">
        <img src={llamaLogo} alt="LlamaMaps" />
        <span className="t2-footer-logo-name">llamamaps</span>
      </a>

      <p className="t2-footer-tagline">Find out how we can help your business grow online.</p>

      <nav className="t2-footer-links">
        {footerLinks.map((l) => (
      ...
      <div className="t2-footer-bottom">
        <p className="t2-footer-copy">© {new Date().getFullYear()} LlamaMaps. All rights reserved.</p>
