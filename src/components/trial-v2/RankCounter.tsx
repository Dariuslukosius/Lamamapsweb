...
const RankCounter = () => {
  ...
  return (
    <div className="t2-rank-counter">
      <span className="t2-rank-counter-label">Typical client ranking movement</span>
      <div className="t2-rank-counter-display">
        <span className="t2-rank-counter-hash">#</span>
        <span className="t2-rank-counter-num">{rank}</span>
      </div>
    </div>
  );
};
