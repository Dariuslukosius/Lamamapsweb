...
import { useNearViewport } from "@/components/trial-v2/useNearViewport";
...
const BeforeAfterSlider = ({ before, after, beforeLabel, afterLabel, pin }: BeforeAfterSliderProps) => {
  ...
  return (
    <div className="t2-baf" ref={cardRef}>
      <div className="t2-baf-labels">
        <span className="t2-baf-label t2-baf-label--before">{beforeLabel}</span>
        <span className="t2-baf-label t2-baf-label--after">{afterLabel}</span>
      </div>
      <div
        className="t2-baf-frame"
        ref={frameRef}
      ...
      >
        <img
          ...
          alt="After"
          className="t2-baf-img"
          draggable={false}
          loading="lazy"
          decoding="async"
        />
        <div
          className="t2-baf-clip"
        ...
        <div className="t2-baf-line" style={{ left: `${pos}%`, transition: transitionStyle }} />
        <div className="t2-baf-handle" style={{ left: `${pos}%`, transition: transitionStyle }}>
          <span className="t2-baf-handle-arrow">‹</span>
          <span className="t2-baf-handle-arrow">›</span>
        </div>
        {pin}
      </div>
