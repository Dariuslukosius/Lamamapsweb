...
const TrialFloatingCta = () => {
  ...
  // under it — on a page this long (~30,000px on /trial-v4) that corner
  ...
  useEffect(() => {
    const hero = document.getElementById("t4-home");
  ...
  return (
    <button
      type="button"
      className={`t4-floating-cta${shown ? " t4-floating-cta--in" : ""}`}
