...
const PlanRadiusMap = ({ plan }: { plan: PlanRadiusKey }) => {
  ...
  return (
    <figure className="t4-planmap">
      <img
        className="t4-planmap-img"
        src={src}
        width={640}
        height={640}
        loading="lazy"
      ...
      <span className="t4-planmap-radius">{label}</span>
      <span className="t4-planmap-area">{area} mi²</span>
