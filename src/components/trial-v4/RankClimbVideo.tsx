...
import rankClimbVideo from "@/assets/trial-v4/rank-climb-demo.webm";
...
const RankClimbVideo = () => {
  ...
  return (
    <div className="t4-rank-climb-video">
      <span className="t4-rank-climb-video-label">Typical client ranking movement</span>
      <video
        ref={videoRef}
        className="t4-rank-climb-video-media"
        src={rankClimbVideo}
