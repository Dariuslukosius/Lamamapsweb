...
const HeroRankClimb = () => (
  <div className="t4-rankclimb">
    <div className="t4-rankclimb-label">
      <span>📍</span>
      <span>Your Google Maps position</span>
    </div>
    <div className="t4-rankclimb-list">
      {competitors.map((name, i) => (
        <div key={name} className="t4-rankclimb-row">
          <span className="t4-rankclimb-row-rank">{i + 2}</span>
          <span>{name}</span>
        </div>
      ))}
      <div className="t4-rankclimb-you">
        <span className="t4-rankclimb-row-rank t4-rankclimb-row-rank--you">1</span>
