...
const TrialFooter = () => (
  <footer id="contacts" className="l3-footer">
    <div className="l3-footer-inner">
      <a href="#l3-home" className="l3-footer-logo">
        <img src={llamaLogo} alt="LlamaMaps" />
        <span className="l3-footer-logo-name">llamamaps</span>
      </a>

      <p className="l3-footer-tagline">Find out how we can help your business grow online.</p>

      <nav className="l3-footer-links">
        {footerLinks.map((l) => (
      ...
      <div className="l3-footer-bottom">
        <p className="l3-footer-copy">© {new Date().getFullYear()} LlamaMaps. All rights reserved.</p>
        <div className="l3-footer-socials">
          {socialLinks.map((s) => {
            const Icon = s.icon;
            return (
