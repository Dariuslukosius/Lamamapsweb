...
const HeroRankClimb = () => (
  <div className="l3-rankclimb">
    <div className="l3-rankclimb-label">
      <span>📍</span>
      <span>Your Google Maps position</span>
    </div>
    <div className="l3-rankclimb-list">
      {competitors.map((name, i) => (
        <div key={name} className="l3-rankclimb-row">
          <span className="l3-rankclimb-row-rank">{i + 2}</span>
          <span>{name}</span>
        </div>
      ))}
      <div className="l3-rankclimb-you">
        <span className="l3-rankclimb-row-rank l3-rankclimb-row-rank--you">1</span>
