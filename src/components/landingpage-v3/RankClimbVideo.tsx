...
import rankClimbVideo from "@/assets/landingpage-v3/rank-climb-demo.webm";
...
const RankClimbVideo = () => {
  ...
  return (
    <div className="l3-rank-climb-video">
      <span className="l3-rank-climb-video-label">Typical client ranking movement</span>
      <video
        ref={videoRef}
        className="l3-rank-climb-video-media"
        src={rankClimbVideo}
