...
const HeroRankClimb = () => (
  <div className="t3-rankclimb">
    <div className="t3-rankclimb-label">
      <span>📍</span>
      <span>Your Google Maps position</span>
    </div>
    <div className="t3-rankclimb-list">
      {competitors.map((name, i) => (
        <div key={name} className="t3-rankclimb-row">
          <span className="t3-rankclimb-row-rank">{i + 2}</span>
          <span>{name}</span>
        </div>
      ))}
      <div className="t3-rankclimb-you">
        <span className="t3-rankclimb-row-rank t3-rankclimb-row-rank--you">1</span>
