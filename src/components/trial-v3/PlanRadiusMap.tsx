...
const PlanRadiusMap = ({ plan }: { plan: PlanRadiusKey }) => {
  ...
  return (
    <figure className="t3-planmap">
      <img
        className="t3-planmap-img"
        src={src}
        width={640}
        height={640}
        loading="lazy"
      ...
      <span className="t3-planmap-radius">{label}</span>
      <span className="t3-planmap-area">{area} mi²</span>
