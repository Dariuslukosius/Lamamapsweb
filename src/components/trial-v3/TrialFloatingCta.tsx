...
const TrialFloatingCta = () => {
  ...
  // under it — on a page this long (~30,000px on /trial-v3) that corner
  ...
  useEffect(() => {
    const hero = document.getElementById("t3-home");
  ...
  return (
    <button
      type="button"
      className={`t3-floating-cta${shown ? " t3-floating-cta--in" : ""}`}
