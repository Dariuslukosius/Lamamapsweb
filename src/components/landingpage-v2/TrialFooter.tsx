...
const TrialFooter = () => (
  <footer id="contacts" className="l2-footer">
    <div className="l2-footer-inner">
      <a href="#l2-home" className="l2-footer-logo">
        <img src={llamaLogo} alt="LlamaMaps" />
        <span className="l2-footer-logo-name">llamamaps</span>
      </a>

      <p className="l2-footer-tagline">Find out how we can help your business grow online.</p>

      <nav className="l2-footer-links">
        {footerLinks.map((l) => (
      ...
      <div className="l2-footer-bottom">
        <p className="l2-footer-copy">© {new Date().getFullYear()} LlamaMaps. All rights reserved.</p>
        <div className="l2-footer-socials">
          {socialLinks.map((s) => {
            const Icon = s.icon;
            return (
