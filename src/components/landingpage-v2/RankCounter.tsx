...
const RankCounter = () => {
  ...
  return (
    <div className="l2-rank-counter">
      <span className="l2-rank-counter-label">Typical client ranking movement</span>
      <div className="l2-rank-counter-display">
        <span className="l2-rank-counter-hash">#</span>
        <span className="l2-rank-counter-num">{rank}</span>
      </div>
    </div>
  );
};
