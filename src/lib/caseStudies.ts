...
/**
 * Case studies shown on /trial and /trial-hormozi.
 *
...
/** Builds the four rows every grid-scan card shows, in a fixed order. */
const scanMetrics = (
  term: string,
  rankStart: string,
  rankNow: string,
...
/*
 * TODO (needs real client data — not derivable from the rank scans):
 * add a business-outcome row to whichever grid-scan cases you have figures for:
 *   { label: "Enquiries increased", value: "3.1x" },
 * Left out rather than estimated: the GIFs prove ranking movement and dates,
 * nothing about call or booking volume.
 */
export const caseStudies: CaseStudy[] = [
  {
    ...
    metrics: scanMetrics("architectural metalwork", "21 across the whole grid", "1 across the whole grid", "19 weeks"),
  },
  {
    ...
    metrics: scanMetrics("tortilijos panevezys", "21 across the grid", "1–2 across the grid", "8 weeks"),
  },
  {
    ...
    metrics: scanMetrics("auto hail repair", "5–13 across the grid", "1–3 across the grid", "14 weeks"),
  },
  {
    ...
    metrics: scanMetrics("residential dog training birmingham", "4–15 across the grid", "2–4 across the grid", "10 weeks"),
  },
  {
    ...
    metrics: scanMetrics("1 on 1 dog training", "6–20 across the grid", "1–3 across most of the grid", "6 weeks"),
  },
  {
    ...
    beforeLabel: "Before · 2 Oct 2025",
    afterLabel: "After · 11 Dec 2025",
    metrics: scanMetrics("canine training", "5–21 across the grid", "1–3 across central Birmingham", "10 weeks"),
  },
  {
    ...
    metrics: scanMetrics("profesionalūs vairavimo kursai kaune", "5–20 across the grid", "1–3 across most of the grid", "1 week"),
  },
  {
    ...
    beforeLabel: "Before · 26 Jun 2026",
    afterLabel: "After · 2 Jul 2026",
    metrics: scanMetrics("geriausi b kategorijos kursai kaune", "4–13 across the grid", "1–2 across most of the grid", "1 week"),
  },
  {
    ...
    metrics: scanMetrics("furniture removalists sunshine coast", "4–16 across the grid", "1–2 across most of the grid", "9 weeks"),
  },
  {
    ...
    metrics: scanMetrics("schmitz centras", "21 across the whole grid", "1 across nearly the whole grid", "10 weeks"),
  },
  {
    ...
    beforeLabel: "Before · 26 Mar 2026",
    afterLabel: "After · 1 Jun 2026",
    metrics: scanMetrics("schmitz dalys vilnius", "21 across the whole grid", "1 across the whole grid", "10 weeks"),
  },
  {
    ...
    beforeLabel: "Before · 26 Mar 2026",
    afterLabel: "After · 1 Jun 2026",
    metrics: scanMetrics("schmitz servisas", "21 across nearly the whole grid", "1–2 across the whole grid", "10 weeks"),
  },
  {
    slug: "nida-renginiai",
    ...
    metrics: scanMetrics("renginiai neringa", "4–21 across the grid", "1–3 across most of the grid", "1 week"),
  },
  {
    ...
    beforeLabel: "Before · 3 Jun 2026",
    afterLabel: "After · 10 Jun 2026",
    metrics: scanMetrics("renginių erdvė nida", "5–8 across the grid", "2–3 across most of the grid", "1 week"),
  },
  {
    slug: "jean-seo-dubai",
    ...
    metrics: scanMetrics("local seo near me", "5–21 across the grid", "1–2 across most of the grid", "1 week"),
  },
  {
    ...
    metrics: scanMetrics("veterinarijos klinika vilniuje", "3–21 across the grid", "1–2 across most of the grid", "1 week"),
  },
  {
    ...
    metrics: scanMetrics("pizza juodkrantė", "4 across the grid", "2 across the grid", "1 week"),
  },
];
